...
function DonateNFT({
  ...
  console.log('🚀 ~ file: DonateNFT.js:26 ~ provider:', provider)
  console.log('🚀MY____ wallet:', wallet)
  ...
  console.log('🚀 ~ file: DonateNFT.js:38 ~ donationAmmount:', donationAmmount)
  ...
  const superFluidStreamPayment = async () => {
    console.log('Click')
    ...
    console.log('initilizing', sf)

    const daix = await sf.loadSuperToken('fDAIx')
    console.log('get daiToken', daix)
    ...
    let createFlowOp = daix.createFlow({
      ...
      receiver: selectedProfile
        ...
        : '0xA41A75Afbf2E7dE5DE8FF764AFa75b4CF54FCA85',
      flowRate: '10',
    })
  ...
  const streamPayment = async () => {
    ...
    const createFlowOperation = sf.cfaV1.createFlow({
      ...
      flowRate: 1, // pass it on, amountToSend /10**18
          ...
          {donateNfts ? (
            ...
            <form className="form" noValidate autoComplete="off">
              ...
              <Button
                ...
                variant="contained"
                color="primary"
                onClick={superFluidStreamPayment}
